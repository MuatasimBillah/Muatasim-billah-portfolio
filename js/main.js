...
// Fast, optimized smooth scroll function 
function initEnhancedSmoothScroll() {
  // Get all links that should have smooth scrolling
  ...
  scrollLinks.forEach(link => {
    link.addEventListener('click', function(e) {
      ...
      smoothScrollTo(offsetPosition, 500); // 500ms duration - faster than default
    });
  });
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  initEnhancedSmoothScroll(); // Add this line for fast smooth scrolling
  initBlogLoading(); // Add this line for blog loading
