// Modern Stylish Preloader with Particle Effect and Updated Bold Purple MB Favicon
const modernPreloader = {
    ...
    addFavicon: function() {
      // UPDATED: Create bold favicon SVG with gradient background and rounded corners
      const faviconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        ...
        <text x="50" y="65" 
              ...
              text-anchor="middle" 
              fill="white"
              style="filter: drop-shadow(0px 2px 3px rgba(0,0,0,0.3));">MB</text>
      </svg>`;
